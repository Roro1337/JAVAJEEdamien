	...
	<div id="background">
		...
		<div id="info2">
			...
			<div style="position: absolute; top: -85px; left: 340px;">
				<h2 style="color: blue;">%nomEtudiant%</h2>
			</div>
			<div style="position: absolute; top: -65px; left: 340px;">
				<h2 style="color: blue;">%prenomEtudiant%</h2>
			</div>
			...
			<div id="formationLyon">
					...
					<div class="rTable">
						<div class="rTableRow">
							...
							<div class="rTableHead" style="width: 39%">
								<span style="font-weight: bold;">Précision</span>
							</div>
							<div class="rTableHead" style="width: 39%">Niveau</div>
						</div>
						<div class="rTableRow">
							<div class="rTableCell" style="width: 20%">%typeCom%</div>
							<div class="rTableCell" style="width: 39%">%precisionCom%</div>
							<div class="rTableCell" style="width: 39%">%niveauCom%</div>
						</div>
					</div>
				</div>
				<div style="width: 700px; height: 200px; overflow: auto">
					...
					<div class="rTable">
						...
						<div class="rTableRow">
							<div class="rTableCell" style="width: 20%">%dateExp%</div>
							<div class="rTableCell" style="width: 20%">%entrepriseExp%</div>
							<div class="rTableCell" style="width: 20%">%posteExp%</div>
							<div class="rTableCell" style="width: 38%">%descriptionExp%</div>
						</div>
					</div>
				</div>
				<div style="width: 700px; height: 200px; overflow: auto">
					...
					<div class="rTable">
						<div class="rTableRow">
							...
							<div class="rTableHead" style="width: 39%">
								<span style="font-weight: bold;">Diplôme</span>
							</div>
							<div class="rTableHead" style="width: 39%">Ecole</div>
						</div>
						<div class="rTableRow">
							<div class="rTableCell" style="width: 20%">%dateSco%</div>
							<div class="rTableCell" style="width: 39%">%diplomeSco%</div>
							<div class="rTableCell" style="width: 39%">%ecoleSco%</div>
						</div>
					</div>
				</div>
			</div>
